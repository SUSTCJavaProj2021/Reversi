...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\com\demo\reversi\AppLauncher.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --main-class com.demo.reversi.AppLauncher ^
  --main-jar %MAIN_JAR% ^
  --java-options -Xmx2048m ^
  --runtime-image target/java-runtime ^
  --icon src/main/java/com/demo/reversi/themes/AppIcon.png ^
  --app-version %APP_VERSION% ^
  --vendor "TestPlatform" ^
  --copyright "Copyright © 2021 TestPlatform" ^
  --win-dir-chooser ^
  --win-shortcut ^
